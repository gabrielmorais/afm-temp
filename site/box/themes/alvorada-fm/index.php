					...
					?>
						<div class="item <?php echo ( $count_relampago == 1 ) ? 'active' : '' ?>">
							...
							<a href="<?php the_permalink(); ?>"><img alt="Carousel Bootstrap First" src="<?php echo $thumb_relampago[0] ?>"></a>
								<p><a class="tag" href="">PROMOÇÃO RELÂMPAGO</a></p>
							</div>
							<div class="carousel-caption">
								...
								<p>
									<a href="<?php the_permalink(); ?>" class="link-refresh"><?php echo get_field( 'resumo' ) ?></a>
								</p>
								...
								<p class="textcenter share-promo promocao-relampago-home">
									<a href="<?php the_permalink(); ?>" class="btn btn-default link-refresh">Veja mais</a>
			...
			?>
				<div class="row">
					<div class="col-md-8 with-image">
						...
						<div class="infos">
							<p class="data"><?php echo get_the_date( 'd/M', $news[0]->ID ); ?> <span>|</span> <?php the_terms( $news[0]->ID, array( 'taxonomy' => 'category' ) ); ?></p>
							<h3>
						...
						<div class="carousel slide" id="slider-destaque">
							...
							<div class="carousel-inner">
								...
								<div class="item <?php echo ( $count_musicais == 1 ) ? 'active' : '' ?>">
									...
									<div class="carousel-caption">
										<p class="data"><?php echo get_the_date( 'd M', $news[0]->ID ); ?> <span>|</span> <?php the_terms( get_the_ID(), array( 'taxonomy' => 'category' ) ); ?></p>
										<h4>
											<a href="<?php the_permalink(); ?>" class="link-refresh"><?php the_title(); ?></a>
										</h4>
										<p>
				...
				<div class="row">
					<?php unset( $news[0] ); if( ! empty( $news ) ) foreach( $news as $new ) : ?>
						<div class="col-md-4 noticia">
							<p class="data"><?php echo get_the_date( 'd M', $new->ID ); ?> <span>|</span> <?php the_terms( $new->ID, array( 'taxonomy' => 'category' ) ); ?></p>
							<h4>
...
<!-- 				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#slider-colunistas">
					</li>
					<li data-slide-to="1" data-target="#slider-colunistas">
					</li>
					<li data-slide-to="2" data-target="#slider-colunistas">
					</li>
				</ol> -->
				<div class="carousel-inner">

					<?php $count_colunista = 1;  foreach( $colunistas as $colunista ) :
					...
					$link_colunista = get_post_type_archive_link( 'conteudo' ).'?col='.$colunista->ID;
					...
					if( $conteudo_colunista->have_posts() ) :
					...
					<div class="item <?php echo ( $count_colunista == 1 ) ? 'active' : null ?>">
						...
						?>
							<div class="container container-content">
								...
								<div class="col-md-6">
									<div class="carousel-caption">
										<p class="data"><?php the_date( 'd M' ) ?> <span>|</span> <?php the_terms( get_the_ID(), 'category' ); ?></p>
										<h4>
											<a href="<?php the_permalink(); ?>" class="link-refresh"><?php the_title(); ?></a>
										</h4>
										<p>
						...
						<div class="col-md-8 col-perfil-colunista">
							...
							<div class="perfil-colunista textcenter">
								<div class="infos">
									...
									<div class="img hvr-buzz-out" style="background-image: url(<?php echo $avatar_colunista['sizes']['avatar-colunista'] ?>)"><a href="<?php echo $link_colunista ?>"><span  style="width:100%;height:100%;display:block"></span></a></div>
									<div class="text">
			...
			<div class="carousel slide" id="slider-eventos">
				...
				<div class="carousel-inner">
					...
					<div class="item <?php echo ( $current_evento == 1 ) ? 'active' : null ?>">
						...
						<div class="carousel-caption">
							<p class="data"><?php echo strftime( '%d de %B', strtotime( $data_do_evento[0]['data'] ) ); ?> <span>|</span>  <?php the_terms( get_the_ID(), array( 'taxonomy' => 'categoria' ) ); ?></p>
							<h4>
								<a href="<?php the_permalink(); ?>" class="link-refresh"><?php echo get_the_title(); ?></a>
							</h4>
<!-- 							<p>
								<a href="<?php the_permalink(); ?>"><?php echo wp_trim_words( get_the_content(), 12 ); ?></a>
							</p> -->

							<p class="footer">
								<a href="<?php echo esc_url( get_post_type_archive_link( 'evento' ) ); ?>" class="link-refresh">VEJA TODOS</a>

										<a data-url="<?php the_permalink(); ?>" data-title="" data-network="facebook" href="" class="fr mleft15 social share-link"><i class="fa fa-facebook"></i></a>
										<a data-url="<?php the_permalink(); ?>" data-title="" data-network="twitter" href="" class="fr social share-link"><i class="fa fa-twitter"></i></a>
...
<section class="jukebox">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="item-a col-xs-12 col-sm-6 col-md-12">
				...
				?>
						...
						<a href="<?php echo $publicidades[0]['link'] ?>" target="_blank">
							<img alt="<?php echo $publicidades[0]['link']; ?>" src="<?php echo $publicidades[0]['imagem'] ?>" />
						</a>
			...
			<div class="item-b col-xs-12 col-sm-6 col-md-12"><a href=""><img alt="" src="<?php echo IMG_URL ?>app-pub.jpg"></a></div>
			</div>
		</div>
	</div>
	</div>
				...
				?>
				    <div class="item <?php //echo ( $count_carousel_colunistas == 1 ) ? 'active' : null; ?>">
				      ...
				      <a href="#" alt="">
				      		...
				      		<img src="<?php echo get_field( 'avatar', $colunista->ID )['sizes']['avatar-colunista'] ?>" class="img-responsive lena-desaturate">
				      </a>
				      </div>
				    </div>
